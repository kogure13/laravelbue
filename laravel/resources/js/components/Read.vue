      ...
      <div class="col-md-12">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr v-for="log_access in log_access" :key="log_access.id">
              <td style="width:40%">{{log_access.ip}}</td>
              <td style="width:40%">{{log_access.agent}}</td>
              <td style="width:20%">
                <router-link class="btn btn-warning" :to="'/detail/'+log_access.id">Update</router-link>
                <button class="btn btn-danger" v-on:click="deleteData(log_access.id)">Delete</button>
              </td>
            </tr>
          </tbody>
        </table>
